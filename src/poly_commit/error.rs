...
impl core::fmt::Display for Error {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            ...
            Error::DegreeIsZero =>
                write!(f, "this scheme does not support committing to degree 0 polynomials"),
            ...
            Error::HidingBoundIsZero =>
                write!(f, "this scheme does not support non-`None` hiding bounds that are 0"),
            Error::HidingBoundToolarge { hiding_poly_degree, num_powers } =>
                write!(
                    f,
            ...
            Error::IncorrectDegreeBound { poly_degree, degree_bound, supported_degree, label } =>
                write!(
                    f,
            ...
            Error::InvalidNumberOfVariables =>
                write!(f, "An invalid number of variables was provided to `setup`"),
            Error::PolynomialDegreeTooLarge { poly_degree, supported_degree, label } =>
                write!(
                    f,
                    "the polynomial {} has degree {:?}, but parameters only
                support up to degree ({:?})",
                    label,
                    poly_degree,
                    supported_degree
                ),
