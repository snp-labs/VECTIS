use crate::{
    ...
    BccGroth16, Commitment, CommittingKey, Proof, ProvingKey, VerifyingKey,
};
...
impl<E: Pairing, QAP: R1CSToQAP, const M: usize> BccGroth16<E, QAP, M> {
    ...
    pub fn create_proof_with_reduction_and_matrices(
        ...
        let proof =
            Self::create_proof_with_assignment(pk, r, s, cm, &h, input_assignment, aux_assignment)?;
    ...
    fn create_proof_with_assignment(
        ...
        let v_delta_eta_g1 = pk.delta_eta_g1.mul(cm.opening);
        let mut g_c = s_g_a;
        g_c += &r_g1_b;
        g_c -= &r_s_delta_g1;
        g_c += &l_aux_acc;
        ...
        C: ConstraintSynthesizer<E::ScalarField>,
    {
        ...
        Self::create_proof_with_reduction(circuit, pk, r, s, cm)
    }
